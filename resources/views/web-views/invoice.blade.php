                                ...
                                <td>
                                    @if ($order->shippingAddress)
                                        ...
                                        <div class="h4 montserrat-normal-600">
                                            <p class="font-weight-normal" style=" margin-top: 6px; margin-bottom:0px;">{{$order->customerAsSeller !=null? $order->customerAsSeller['f_name'].' '.$order->customerAsSeller['l_name']:\App\CPU\translate('name_not_found')}}</p>
                                            <p class="font-weight-normal" style=" margin-top: 6px; margin-bottom:0px;">{{$order->customerAsSeller !=null? $order->customerAsSeller['email']:\App\CPU\translate('email_not_found')}}</p>
                                            <p class="font-weight-normal" style=" margin-top: 6px; margin-bottom:0px;">{{$order->customerAsSeller !=null? $order->customerAsSeller['phone']:\App\CPU\translate('phone_not_found')}}</p>
                                    ...
                                    @else
                                        ...
                                        <div class="h4 montserrat-normal-600">
                                            <p class="font-weight-normal" style=" margin-top: 6px; margin-bottom:0px;">{{$order->customerAsSeller !=null? $order->customer['f_name'].' '.$order->customerAsSeller['l_name']:\App\CPU\translate('name_not_found')}}</p>
