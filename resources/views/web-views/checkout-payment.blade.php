        ...
        <div class="row">
            <div class="col-md-12 mb-5 pt-5">
                <div class="feature_header __feature_header" style="background: transparent !important;">
                    <span style="text-transform:capitalize; font-size:33.23px;">{{ \App\CPU\translate('payment_method')}}</span>
                </div>
            </div>
                ...
                <!-- Payment methods accordion-->
                                        ...
                                        <div class="card-body __h-100px">
                                                <button class="btn btn-block click-if-alone" type="submit"
                                                    ...
                                                    <img width="150" class="__mt-n-10"
                                                        src="{{asset('public/assets/front-end/img/new_wallet.png')}}" style="width:120px;"/>
                                                </button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="cursor-pointer">
                                        <div class="card-body __h-100px">
                                            <form class="needs-validation" method="POST" id="payment-form"
                                                ...
                                                <button class="btn btn-block click-if-alone" type="submit">
                                                    <img width="150"
                                                        src="{{asset('public/assets/front-end/img/new_paypal.png')}}" style="width:120px;"/>
                                                </button>
                                            </form>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cursor-pointer">
                                        <div class="card-body __h-100px">
                                            <button class="btn btn-block click-if-alone" type="button" id="checkout-button">
                                                ...
                                                <img width="150" src="{{asset('public/assets/front-end/img/new_stripe.png')}}" style="width:120px;"/>
                                            </button>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12 text-center mt-5">
                            <a class="btn btn-secondary btn-block btnShipping custom_btn" style="padding:10px 15px !important;" href="{{route('checkout-details')}}">
