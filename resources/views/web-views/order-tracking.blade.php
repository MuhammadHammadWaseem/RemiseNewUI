                            ...
                            <div class="nav-link">
                                <div class="align-items-center">
                                    ...
                                    <div class="media-body text-center">
                                        ...
                                        <h6 style="color: #ff061e;font-weight: bold;font-size: 16px;" class="media-tab-title text-nowrap mb-0">{{ \App\CPU\translate('Order placed')}}</h6>
                                    </div>
                                </div>
                            </div>
                        </li>
                            ...
                            <div class="nav-link ">
                                <div class="align-items-center">
                                    ...
                                    <div class="media-body text-center">
                                        ...
                                        <h6 style="color: #ff061e;font-weight: bold;font-size: 16px;" class="media-tab-title text-nowrap mb-0">{{ \App\CPU\translate('Packaging order')}}</h6>
                                    </div>
                                </div>
                            </div>
                        </li>
                            ...
                            <div class="nav-link  ">
                                <div class="align-items-center">
                                    ...
                                    <div class="media-body text-center">
                                        ...
                                        <h6 style="color: #ff061e;font-weight: bold;font-size: 16px;" class="media-tab-title text-nowrap mb-0">{{ \App\CPU\translate('Preparing Shipment')}}</h6>
                                    </div>
                                </div>
                            </div>
                        </li>
                            ...
                            <div class="nav-link ">
                                <div class="align-items-center">
                                    ...
                                    <div class="media-body text-center">
                                        ...
                                        <h6 style="color: #ff061e;font-weight: bold;font-size: 16px;" class="media-tab-title text-nowrap mb-0">{{ \App\CPU\translate('Order Shipped')}}</h6>
                                    </div>
                                </div>
                            </div>
                        </li>
