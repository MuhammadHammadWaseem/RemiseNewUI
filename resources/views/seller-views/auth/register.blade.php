    ...
    <div class="container my-3 pb-5 innerArea_new register">
        ...
        <div class="col-12 logo text-center">
            ...
            <div class="col-12 text_area1">
                ...
                <h1 class="top-text" style="font-size:60px; font-family: 'BURBANKBIGCONDENSED-BOLD';">Welcome To Remise Fencing Gear</h1>
                <h4 style="font-family:Poppins;">Your one stop site for buying and selling pre used fencing gear.</h4>

                <span class="span_text"> <small> Create Your Account
        ...
        <div class="Ship-Ser-form">
            ...
            {{-- <h3 class="mb-3 text-center"> {{\App\CPU\translate('Shop')}} {{\App\CPU\translate('Application')}}</h3> --}}
                            ...
                            <div class="form-group ship-form">
                                ...
                                <input type="text" class="form-control ship-control form-control-user" id="exampleFirstName" name="f_name" value="{{old('f_name')}}" placeholder="John" required>
                            ...
                            <div class="form-group ship-form">
                                ...
                                <input type="text" class="form-control ship-control form-control-user" id="exampleLastName" name="l_name" value="{{old('l_name')}}" placeholder="Doe"  required>
                            ...
                            <div class="form-group ship-form">
                                ...
                                <input type="email" class="form-control ship-control form-control-user" id="exampleInputEmail" name="email" value="{{old('email')}}" placeholder="xyz@gmail.com" required>
                            ...
                            <div class="form-group ship-form">
                                ...
                                <label class="lblClr" for="reg-phone">{{\App\CPU\translate('phone_number')}}
                                    ...
                                    <input type="number" class="form-control ship-control form-control-user" id="exampleInputPhone" name="phone" value="{{old('phone')}}" placeholder="+123456789"  required>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="form-group ship-form">
                                        ...
                                        <input name="address" class="form-control ship-control" value="{{ old('address') }}" placeholder="address" id="address"rows="1">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group ship-form">
                                        ...
                                        <input placeholder="city" name="city" class="form-control ship-control" value="{{ old('city') }}" id="city"rows="1" >
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group ship-form">
                                        ...
                                        <input placeholder="state" name="state" class="form-control ship-control" value="{{ old('state') }}" id="state"rows="1" >
                                    </div>
                                </div>
                            </div>
    ...
    <option value="ZW">Zimbabwe</option>
                                ...
                                <div class="col-6">
                                    <div class="form-group ship-form">
                                        ...
                                        <input placeholder="postal code" name="postal_code" class="form-control ship-control" value="{{ old('postal_code') }}" id="postal_code"rows="1">
                                    </div>
                                </div>
                            </div>
                            <!--<div class="form-group ship-form">-->
                            ...
                            <div style="z-index: 80;" class="form-group ship-form passINPUT" >

                                <label class="lblClr" for="si-password">{{\App\CPU\translate('password')}}</label>

                                        <div class="password-toggle">

                                            <input type="password" class="form-control ship-control form-control-user" minlength="6" id="exampleInputPassword" name="password" placeholder="********" required>
                            ...
                            <div style="z-index: 80;" class="form-group ship-form passINPUT">
                                ...
                                <label class="lblClr" for="si-password">{{\App\CPU\translate('confirm_password')}}</label>
                                        ...
                                        <div class="password-toggle">
                                            ...
                                            <input placeholder="********" type="password" class="form-control ship-control form-control-user" minlength="6" id="exampleRepeatPassword"  required>
                                        ...
                                        <div class="col-sm-12 text-center">
                                            ...
                                            <div class="custom-file mt-3 ">
                                                ...
                                                <label class="custom-file-label  browseImg" for="customFileUpload">{{\App\CPU\translate('Upload')}} {{\App\CPU\translate('image')}} <small>(Optional)</small></label>
...
<!--                                        </div>-->
                    ...
                    @endif
                        ...
                        <button type="submit" class="btn ship-sub-btn btn-user btn-block" id="apply" disabled>
                            {{--  {{\App\CPU\translate('Apply')}} {{\App\CPU\translate('Shop')}}  --}}
                            Create Account
                        </button>
