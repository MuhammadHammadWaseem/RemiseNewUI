...
@section('title', \App\CPU\translate('Seller Dashboard'))
            ...
            <div class="flex-between row align-items-center mx-1">
                ...
                <div>
                    <a class="btn btn--primary" href="{{ route('home') }}">
                        <i class="fa fa-home mr-1"></i> {{ \App\CPU\translate('Go to Shop') }}
                    </a>
                    
                    <a class="btn btn--primary" href="{{route('seller.product.list')}}">
                        <i class="tio-premium-outlined mr-1"></i> {{\App\CPU\translate('Sell Itmes')}}
                    </a>
                </div>
            </div>
        </div>
