                                                        ...
                                                        <div class="card">
                                                            <div class="card-body">
                                                                <img class="w-100" height="auto"
                                                                     ...
                                                                     alt="Product image">
                                                                <a href="{{route('seller.product.remove-thumbnail-image',['id'=>$product->id,'name'=>$product->thumbnail])}}"
                                                                   class="btn btn-danger btn-block">{{\App\CPU\translate('Remove')}}</a>
                                                            </div>
                                                            <div class="align-two-checkboxes" bis_skin_checked="1">
                                                                <div class="form-group mt-2" bis_skin_checked="1">
                                                        ...
                                                        <div class="card">
                                                            <div class="card-body">
                                                                <img class="w-100" height="auto"
                                                                     ...
                                                                     alt="Product image">
                                                                <a href="{{route('seller.product.remove-meta-image',['id'=>$product->id,'name'=>$product->meta_image])}}"
                                                                   class="btn btn-danger btn-block">{{\App\CPU\translate('Remove')}}</a>
                                                            </div>
                                                                <div class="align-two-checkboxes" bis_skin_checked="1">
                                                                    <div class="form-group mt-2" bis_skin_checked="1">
