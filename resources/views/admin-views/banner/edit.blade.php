                        ...
                        <form action="{{route('admin.banner.update',[$banner['id']])}}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="js-example-responsive form-control w-100"
                                            ...
                                            <option
                                                value="Promo Banner" {{$banner['banner_type']=='Promo Banner'?'selected':''}}>Promotion Banner</option>
                                            <option
                                                value="Today Banner Left" {{$banner['banner_type']=='Today Banner Left'?'selected':''}}>Today's Banner Left</option>
                                            <option
                                                value="Today Banner Right" {{$banner['banner_type']=='Today Banner Right'?'selected':''}}>Today's Banner Right</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-6 d-flex flex-column justify-content-end">
                                 ...
                                 <div class="col-md-6 d-flex flex-column justify-content-end">
                                    <div class="form-group mb-0" id="title">
                                        <label for="name" class="title-color text-capitalize">{{ \App\CPU\translate('title')}}</label>
                                        <input type="text" name="title" class="form-control" value="{{$banner['title']}}" required>
                                    </div>
                                </div>
                                <div class="col-md-6 d-flex flex-column justify-content-end">
                                    <div class="form-group mb-0" id="description">
                                        <label for="name" class="title-color text-capitalize">{{ \App\CPU\translate('description')}}</label>
