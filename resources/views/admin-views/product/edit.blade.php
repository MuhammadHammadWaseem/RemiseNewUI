                                ...
                                <!--</div>-->
                                    <div class="col-md-4">
                                     <div class="input-checkbox-align">
                                        <label for="
                                        " class="title-color">{{ \App\CPU\translate('Select Hand Orientation') }}</label>
                                        <input class="form-control"  type="checkbox" id="hand_orientation_checkbox" name="hand_orientation_checkbox" 
                                        {{ old('hand_orientation_checkbox', isset($product->hand_orientation) ? 'checked' : '') }}>
                                        </div>
                                        
                                         <div class="check-box-displayed"  id="hand_orientation_dropdown" style="display: {{ isset($product->hand_orientation) ? 'block' : 'none' }};">
                                        ...
                                        <select id="hand_orientation" name="hand_orientation" class="form-control">
                                            <option value="" {{ old('hand_orientation', $product->hand_orientation) == '' ? 'selected' : '' }}>{{ \App\CPU\translate('Select Hand') }}</option>
                                            <option value="RH" {{ old('hand_orientation', $product->hand_orientation) == 'RH' ? 'selected' : '' }}>{{ \App\CPU\translate('Right Hand (RH)') }}</option>
                                            <option value="LH" {{ old('hand_orientation', $product->hand_orientation) == 'LH' ? 'selected' : '' }}>{{ \App\CPU\translate('Left Hand (LH)') }}</option>
                                        </select>
                                    </div
                                    ...
                                    <div class="coba-area">
                                        ...
                                        <div class="row g-2" id="coba">
                                            @if(!empty($product->images))
                                                @foreach (json_decode($product->images) as $key => $photo)
                                                    <div class="col-6 col-lg-4 col-xl-3 spartan_item_wrapper">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                <img class="w-100" height="auto"
                                                                     onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                                                ...
                                                                <a href="{{route('admin.product.remove-image',['id'=>$product['id'],'name'=>$photo])}}"
                                                                   class="btn btn-danger btn-block">{{\App\CPU\translate('Remove')}}</a>
                                                                   <!--<div class="align-two-checkboxes" bis_skin_checked="1">-->
                                                                   <!--     <div class="form-group mt-2" bis_skin_checked="1">-->
                                                                   <!--         <label>-->
                                                                   <!--             <input type="checkbox" name="is_meta[]" value="1"> Meta-->
                                                                   <!--         </label>-->
                                                                   <!--     </div>-->
                                                                   <!--     <div class="form-group mt-2" bis_skin_checked="1">-->
                                                                   <!--         <label>-->
                                                                   <!--             <input type="checkbox" name="is_thumbnail[]" value="1"> Thumbnail-->
                                                                   <!--         </label>-->
                                                                   <!--     </div>-->
                                                                   <!-- </div>-->
                                                            </div>
                                                        ...
                                                        <div class="card">
                                                            <div class="card-body">
                                                                <img class="w-100" height="auto"
                                                                     ...
                                                                     alt="Product image">
                                                                <a href="{{route('admin.product.remove-thumbnail-image',['id'=>$product->id,'name'=>$product->thumbnail])}}"
                                                                   class="btn btn-danger btn-block">{{\App\CPU\translate('Remove')}}</a>
                                                            </div>
                                                            <div class="align-two-checkboxes" bis_skin_checked="1">
                                                                <div class="form-group mt-2" bis_skin_checked="1">
                                                                    <label>
                                                                        <input type="checkbox" name="is_meta[]" value="1" disabled> Meta
                                                                    </label>
                                                                </div>
                                                                    <div class="form-group mt-2" bis_skin_checked="1" >
                                                                        <label>
                                                                            <input type="checkbox" name="is_thumbnail[]" checked value="1" disabled> Thumbnail
                                                                        </label>
                                                                    </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="card">
                                                            <div class="card-body">
                                                                <img class="w-100" height="auto"
                                                                     ...
                                                                     alt="Product image">
                                                                <a href="{{route('admin.product.remove-meta-image',['id'=>$product->id,'name'=>$product->meta_image])}}"
                                                                   class="btn btn-danger btn-block">{{\App\CPU\translate('Remove')}}</a>
                                                            </div>
                                                                <div class="align-two-checkboxes" bis_skin_checked="1">
                                                                    <div class="form-group mt-2" bis_skin_checked="1">
                                                                        <label>
                                                                            <input type="checkbox" name="is_meta[]" checked value="1" disabled> Meta
                                                                        </label>
                                                                    </div>
                                                                    <div class="form-group mt-2" bis_skin_checked="1">
                                                                        <label>
                                                                            <input type="checkbox" name="is_thumbnail[]" value="1" disabled> Thumbnail
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                        </div>
...
@push('script_2')
    ...
    <script>
        ...
        $('input[name="hand_orientation_checkbox"]').on('change', function () {
            const checkbox = $('#hand_orientation_checkbox');
            const dropdown = $('#hand_orientation_dropdown');
            ...
            checkbox.change(function() {
                if ($(this).is(':checked')) {
                    ...
                    dropdown.hide();
                    // Optionally reset the dropdown value when hiding it
                    $('#hand_orientation').val('');
                }
            });
