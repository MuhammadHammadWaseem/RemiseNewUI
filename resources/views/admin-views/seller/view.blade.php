...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="page-header">
            ...
            <!-- Nav Scroller -->
            <div class="js-nav-scroller hs-nav-scroller-horizontal" style="display: flex;justify-content: space-between;">
                <!-- Nav -->
                ...
                <button type="submit"
                        class="btn btn-danger">{{\App\CPU\translate('delete')}}</button>
            </form>
                <!-- End Nav -->
            </div>
