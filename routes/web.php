...
Route::group(['namespace' => 'Web','middleware'=>['maintenance_mode']], function () {
    ...
    Route::get('verification-request', 'WebController@nonSeller')->name('nonSeller');
    Route::post('verification-request', 'WebController@nonSellerRequest')->name('nonSellerRequest');
