...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        // for export seller
        Route::post('/sellers/export','SellerController@exportSeller')->name('sellers.export');
        // SELLERS DELETE
        Route::post('sellers/bulk-delete', 'SellerController@deleteSeller')->name('sellers.bulk-delete');
        ...
        Route::group(['prefix' => 'product', 'as' => 'product.','middleware'=>['module:product_management']], function () {
            ...
            Route::get('remove-thumbnail-image', 'ProductController@remove_thumbnail_image')->name('remove-thumbnail-image');
            Route::get('remove-meta-image', 'ProductController@remove_meta_image')->name('remove-meta-image');
